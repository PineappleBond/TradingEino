...
│   │   ├── okx_watcher/     # DeepAgent coordinator
│   │   ├── risk_officer/    # Risk analysis (to refactor)
│   │   ├── sentiment_analyst/ # Sentiment analysis
│   │   └── tools/           # Agent tools (OKX wrappers)
│   ├── api/                 # HTTP API layer
...
│       ├── models/          # OKX response models
│       └── requests/        # OKX request models
